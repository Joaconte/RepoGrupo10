...
public interface FaseDePartida{
    ...
    void moverBatallon(Tablero tableroDePartida, ArrayList<Ubicacion> ubicaciones, Direccion direccion) throws JugadorYaRealizoLaAccionException, PiezaYaMovioException;
