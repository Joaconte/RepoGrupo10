...
public class BotonMoverUnidadEventHandler implements EventHandler<ActionEvent> {
    ...
    public BotonMoverUnidadEventHandler(Ubicacion ubicacionInicial, Ubicacion ubicacionFinal, Juego juego, Label etiquetaAlerta, VistaDeTablero vistaDeTablero) {
    ...
    public void handle(ActionEvent event) {
        ...
        try {
            ...
            this.comunicadoTexto.setText("Se ha movido a la unidad correctamente" );
