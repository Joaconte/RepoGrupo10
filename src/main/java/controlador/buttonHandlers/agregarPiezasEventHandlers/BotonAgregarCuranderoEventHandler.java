...
public class BotonAgregarCuranderoEventHandler extends BotonAgregarPiezaEventHandler {
    ...
    public BotonAgregarCuranderoEventHandler(TextField textoUno, TextField textoDos, Label etiquetaUno, VistaDeTablero vistaDeTablero, EtiquetaPuntosJugador etiquetaPuntos) {
